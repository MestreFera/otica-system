                    ...
                    <div className="canvas-card p-8 rounded-lg relative z-10 bg-[#0A0A0A]">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="remember" className="w-3.5 h-3.5 rounded-sm bg-[#0A0A0A] border-[1px] border-white/10 checked:bg-[#F97316] checked:border-[#F97316] outline-none cursor-pointer appearance-none relative flex items-center justify-center transition-colors after:content-[''] checked:after:content-['✓'] after:text-[10px] after:text-black after:font-bold" />
                                <label htmlFor="remember" className="text-xs font-mono text-neutral-500 cursor-pointer">Remember me</label>
                            </div>
